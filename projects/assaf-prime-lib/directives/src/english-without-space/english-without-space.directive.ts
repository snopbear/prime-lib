  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => EnglishWithoutSpaceDirective),
      multi: true,
    },
  ],
})
...
{
  //#region Declerations
  private __validationRegex: RegExp = /[^A-Za-z0-9]/g;
   ...
   * @default true
   */
  @Input() englishWithoutSpace: boolean = true;
